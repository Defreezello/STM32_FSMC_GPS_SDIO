...
#define XPT2046_IRQ_Pin       IRQ_TOUCH_Pin
#define XPT2046_IRQ_GPIO_Port IRQ_TOUCH_GPIO_Port
#define XPT2046_CS_Pin        CS_TOUCH_Pin
#define XPT2046_CS_GPIO_Port  CS_TOUCH_GPIO_Port
